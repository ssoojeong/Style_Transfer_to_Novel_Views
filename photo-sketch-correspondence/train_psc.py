...
from utils.losses import MaskMSE, MaskMSE_epi
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    criterion = {
        ...
        "mask_mse": MaskMSE_epi().cuda(args.gpu),
    }
    ...
    for epoch in range(args.start_epoch, args.break_training if args.break_training else args.epochs):
        ...
        if not args.multiprocessing_distributed or (args.multiprocessing_distributed
            ...
            if epoch % args.knn_freq == 0:
                #eval_knn(eval_model, eval_loader, epoch, mem, args, writer, plot=plot, save=str(epoch))
                eval_knn(eval_model, test_loader, epoch, mem, args, writer, plot=plot, save=str(epoch))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--knn-freq', default=1, type=int,
    ...
    parser.add_argument('--plot-freq', default=1, type=int,
